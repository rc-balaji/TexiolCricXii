...
5. Install v1.3.0 on the original match-creator account/device and open/Refresh once so legacy creator-owned active and completed matches are copied to canonical `matches/{matchId}` records.
